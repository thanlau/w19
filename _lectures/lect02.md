---
num: "Lecture 2"
desc: "STL: Vectors and Iterators"
ready: true
...
* There's C++ documentation on which methods certain library objects contain. For example: [http://www.cplusplus.com/reference/vector/vector/?kw=vector](http://www.cplusplus.com/reference/vector/vector/?kw=vector)
...
* `*` symbol dereferences an iterator to get the object
